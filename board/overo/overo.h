...
#define MUX_OVERO() \
 ...
 /*DSS - configured as GPIO*/\
	MUX_VAL(CP(DSS_PCLK),		(IEN  | PTU | EN  | M4)) /*GPIO_66*/\
	MUX_VAL(CP(DSS_HSYNC),		(IEN  | PTU | EN  | M4)) /*GPIO_67*/\
	MUX_VAL(CP(DSS_VSYNC),		(IEN  | PTU | EN  | M4)) /*GPIO_68*/\
	MUX_VAL(CP(DSS_ACBIAS),		(IEN  | PTU | EN  | M4)) /*GPIO_69*/\
	MUX_VAL(CP(DSS_DATA0),		(IEN  | PTU | EN  | M4)) /*GPIO_70*/\
	MUX_VAL(CP(DSS_DATA1),		(IEN  | PTU | EN  | M4)) /*GPIO_71*/\
	MUX_VAL(CP(DSS_DATA2),		(IEN  | PTU | EN  | M4)) /*GPIO_72*/\
	MUX_VAL(CP(DSS_DATA3),		(IEN  | PTU | EN  | M4)) /*GPIO_73*/\
	MUX_VAL(CP(DSS_DATA4),		(IEN  | PTU | EN  | M4)) /*GPIO_74*/\
	MUX_VAL(CP(DSS_DATA5),		(IEN  | PTU | EN  | M4)) /*GPIO_75*/\
	MUX_VAL(CP(DSS_DATA6),		(IEN  | PTU | EN  | M4)) /*GPIO_76*/\
	MUX_VAL(CP(DSS_DATA7),		(IEN  | PTU | EN  | M4)) /*GPIO_77*/\
	MUX_VAL(CP(DSS_DATA8),		(IEN  | PTU | EN  | M4)) /*GPIO_78*/\
	MUX_VAL(CP(DSS_DATA9),		(IEN  | PTU | EN  | M4)) /*GPIO_79*/\
	MUX_VAL(CP(DSS_DATA10),		(IEN  | PTU | EN  | M4)) /*GPIO_80*/\
	MUX_VAL(CP(DSS_DATA11),		(IEN  | PTU | EN  | M4)) /*GPIO_81*/\
	MUX_VAL(CP(DSS_DATA12),		(IEN  | PTU | EN  | M4)) /*GPIO_82*/\
	MUX_VAL(CP(DSS_DATA13),		(IEN  | PTU | EN  | M4)) /*GPIO_83*/\
	MUX_VAL(CP(DSS_DATA14),		(IEN  | PTU | EN  | M4)) /*GPIO_84*/\
	MUX_VAL(CP(DSS_DATA15),		(IEN  | PTU | EN  | M4)) /*GPIO_85*/\
	MUX_VAL(CP(DSS_DATA16),		(IEN  | PTU | EN  | M4)) /*GPIO_86*/\
	MUX_VAL(CP(DSS_DATA17),		(IEN  | PTU | EN  | M4)) /*GPIO_87*/\
	MUX_VAL(CP(DSS_DATA18),		(IEN  | PTU | EN  | M4)) /*GPIO_88*/\
	MUX_VAL(CP(DSS_DATA19),		(IEN  | PTU | EN  | M4)) /*GPIO_89*/\
	MUX_VAL(CP(DSS_DATA20),		(IEN  | PTU | EN  | M4)) /*GPIO_90*/\
	MUX_VAL(CP(DSS_DATA21),		(IEN  | PTU | EN  | M4)) /*GPIO_91*/\
	MUX_VAL(CP(DSS_DATA22),		(IEN  | PTU | EN  | M4)) /*GPIO_92*/\
	MUX_VAL(CP(DSS_DATA23),		(IEN  | PTU | EN  | M4)) /*GPIO_93*/\
 /*CAMERA*/\
