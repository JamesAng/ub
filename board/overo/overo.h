...
#define MUX_OVERO() \
 ...
 /*DSS*/\
	...
	MUX_VAL(CP(DSS_DATA8),		(IDIS | PTD | DIS | M4)) /*GPIO_78*/\
	MUX_VAL(CP(DSS_DATA9),		(IDIS | PTD | DIS | M4)) /*GPIO_79*/\
 ...
 /*Control and debug */\
	...
	MUX_VAL(CP(ETK_CLK_ES2),	(IEN  | PTU | DIS | M1)) /*MCBSP5_CLKX*/\
	...
	MUX_VAL(CP(ETK_D4_ES2),		(IEN  | PTU | DIS | M1)) /*MCBSP5_DR*/\
	MUX_VAL(CP(ETK_D5_ES2),		(IEN  | PTU | DIS | M1)) /*MCBSP5_FSX*/\
	MUX_VAL(CP(ETK_D6_ES2),		(IEN  | PTU | DIS | M1)) /*MCBSP5_DX*/\
