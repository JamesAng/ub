...
#define MUX_ROCKHOPPER() \
 ...
 /*CAMERA*/\
	...
	MUX_VAL(CP(CAM_FLD),		(IDIS | PTD | DIS | M0)) /*CAM_FLD*/\
 ...
 /*CAN */\
	...
	MUX_VAL(CP(MMC2_DAT0),		(IEN  | PTU | DIS | M1)) /*MCSPI3_SOMI*/\
	MUX_VAL(CP(MMC2_DAT1),		(IEN  | PTU | DIS | M4)) /*GPIO_133 CAN_RXB0*/\
	MUX_VAL(CP(MMC2_DAT2),		(IEN  | PTU | DIS | M4)) /*GPIO_134 CAN_INT*/\
	MUX_VAL(CP(MMC2_DAT3),		(IEN  | PTU | DIS | M1)) /*MCSPI3_CS0*/\
	MUX_VAL(CP(MMC2_DAT4),		(IEN  | PTU | DIS | M4)) /*GPIO_136 CAN_RXB1*/\
	MUX_VAL(CP(MMC2_DAT5),		(IEN  | PTU | DIS | M4)) /*GPIO_137 CAN_RTS0*/\
	MUX_VAL(CP(MMC2_DAT6),		(IEN  | PTU | DIS | M4)) /*GPIO_138 CAN_RTS1*/\
	MUX_VAL(CP(MMC2_DAT7),		(IEN  | PTU | DIS | M4)) /*GPIO_139 CAN_RTS2*/\
 /*Bluetooth*/\
	MUX_VAL(CP(MCBSP3_DX),		(IEN  | PTD | DIS | M0)) /*MCBSP3_DX*/\
 ...
 /*GPS */\
	...
	MUX_VAL(CP(UART1_RX),		(IEN  | PTD | DIS | M0)) /*UART1_RX*/\
 	MUX_VAL(CP(MCBSP4_CLKX),	(IEN  | PTD | DIS | M4)) /*GPIO_152 LCD_INI*/\
	MUX_VAL(CP(MCBSP4_DR),		(IEN  | PTD | DIS | M0)) /*MCBSP4_DR*/\
	MUX_VAL(CP(MCBSP4_DX),		(IEN  | PTD | DIS | M4)) /*GPIO_154 LCD_QVGA*/\
	MUX_VAL(CP(MCBSP4_FSX),		(IEN  | PTD | DIS | M4)) /*GPIO_155 LCD_RESB*/\
 /*ACCL */\
	MUX_VAL(CP(MCBSP1_CLKR),	(IEN  | PTD | DIS | M1)) /*MCSPI4_CLK*/\
	MUX_VAL(CP(MCBSP1_FSR),		(IEN  | PTD | DIS | M4)) /*GPIO_157 ACCL_INT1*/\
	MUX_VAL(CP(MCBSP1_DX),		(IEN  | PTD | DIS | M1)) /*MCSPI4_SIMO*/\
	MUX_VAL(CP(MCBSP1_DR),		(IEN  | PTD | DIS | M1)) /*MCSPI4_SOMI*/\
	MUX_VAL(CP(MCBSP_CLKS),		(IEN  | PTU | DIS | M1)) /*MCSPI4_CLK*/\
	MUX_VAL(CP(MCBSP1_FSX),		(IDIS | PTD | DIS | M1)) /*MCSPI4_CS0*/\
	MUX_VAL(CP(MCBSP1_CLKX),	(IDIS | PTD | DIS | M4)) /*GPIO_162 ACCL_INT1*/\
 /*Serial Interface*/\
...
/*MUSB */\
	...
	MUX_VAL(CP(MCSPI1_CLK),		(IEN  | PTU | DIS | M4)) /*GPIO_171*/\
	MUX_VAL(CP(MCSPI1_SIMO),	(IEN  | PTU | DIS | M4)) /*GPIO_172*/\
	MUX_VAL(CP(MCSPI1_SOMI),	(IEN  | PTU | DIS | M4)) /*GPIO_173*/\
	MUX_VAL(CP(MCSPI1_CS0),		(IEN  | PTU | DIS | M4)) /*GPIO_174*/\
	MUX_VAL(CP(MCSPI1_CS1),		(IEN  | PTU | DIS | M4)) /*GPIO_175*/\
	MUX_VAL(CP(MCSPI1_CS2),		(IEN  | PTU | DIS | M4)) /*GPIO_176*/\
	MUX_VAL(CP(MCSPI1_CS3),		(IEN  | PTU | DIS | M4)) /*GPIO_177*/\
/*TS */\
 ...
 /* USB EHCI (port 1) */\
	...
	MUX_VAL(CP(ETK_D10_ES2),	(IEN  | PTU | DIS | M4)) /*GPIO_24 CAN_SOF*/\
	MUX_VAL(CP(ETK_D11_ES2),	(IEN  | PTU | DIS | M4)) /*GPIO_25 BT_RESET*/\
	MUX_VAL(CP(ETK_D12_ES2),	(IEN  | PTU | DIS | M4)) /*GPIO_26 BT_SLEEPX*/\
	MUX_VAL(CP(ETK_D13_ES2),	(IEN  | PTU | DIS | M4)) /*GPIO_27 LCD_UD*/\
	MUX_VAL(CP(ETK_D14_ES2),	(IEN  | PTU | DIS | M4)) /*GPIO_28 LCD_LR*/\
	MUX_VAL(CP(ETK_D15_ES2),	(IEN  | PTU | DIS | M4)) /*GPIO_29 MMC1_WP*/\
